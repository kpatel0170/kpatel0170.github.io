  ...
  return (
    <div className="mb-[100px]">
      ...
      >
        ...
        <div className="lg-1150:w-485px flex flex-col gap-[24px] flex-1 pl-10">
          <h3 className="text-4xl leading-[31px] font-bold md:text-5xl md:leading-[47px]">
            {data.text.heading}
          </h3>
          <ul className="text-md leading-[23px] md:text-[15px] md:leading-[26px] font-normal flex flex-col gap-[10px]">
            {newList}
          </ul>
        </div>
      </div>
