  ...
  return (
    ...
    <div class="timeline">
      <div class="container left">
        ...
        <ul>
            <li><b>blizzardWorld</b> - implemented vintage computer game Nightfall in 6 different versions, using functional programming, object-oriented concepts, data encapsulation, inheritance, and modular programming.</li>
